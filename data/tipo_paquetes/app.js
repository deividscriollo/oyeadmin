...
angular.module('scotchApp').controller('tipo_paquetesController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: 'data/tipo_paquetes/xml_tipo_paquetes.php',
	        autoencode: false,
	        datatype: "xml",
			height: 330,
			...
			colModel:[
				...
				{name:'nombre_paquete',index:'nombre_paquete',width:150, editable:true, editoptions:{size:"20",maxlength:"30"}, editrules: {required: true}},
